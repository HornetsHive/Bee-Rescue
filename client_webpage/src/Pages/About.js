    ...
    <Pane flexDirection="row" alignContent="center" display="flex" justifyContent="center">
      <Pane width="50%" flexDirection="column">
        <InfoCard
          ...
          text ={
          <>
            Our website was commissioned by the Sacramento Area Beekeepers Association (SABA) and created by Computer Science students from California State University, Sacramento as their senior project.<br/><br/>
            The website (as well as the backend server and mobile app which connect to it) were written by the Hornet's Hive team over the Winter 2022 and Spring 2023 semester. The Hornet's Hive team is a group of passionate and driven computer science students from Sacramento State who are dedicated to using their technical skills to make a positive impact in their community. Throughout the development process, our team worked closely with SABA to ensure that Bee Rescue is user-friendly, efficient, and effective in its mission.<br/><br/>
